    ...
    <div className="space-y-6">
      ...
      {showEmptyState && (
        <div className="card p-12 flex flex-col items-center text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-brand-50 to-academic-50 dark:from-brand-900/20 dark:to-academic-900/20 rounded-2xl flex items-center justify-center mb-4">
